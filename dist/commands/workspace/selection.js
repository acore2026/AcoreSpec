...
export async function selectWorkspaceForCommand(options, commandName) {
    ...
    if (options.json || resolveNoInteractive(options) || !isInteractive(options)) {
        throw new WorkspaceCliError('Multiple OpenSpec workspaces are known. Pass --workspace <name>.', 'workspace_selection_ambiguous', {
            target: 'workspace.name',
