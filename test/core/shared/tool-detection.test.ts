...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('openspec-survey');
      expect(SKILL_NAMES).toContain('openspec-integrate');
      expect(SKILL_NAMES).toContain('openspec-rehearse');
      expect(SKILL_NAMES).toContain('openspec-demo');
    });
  });
